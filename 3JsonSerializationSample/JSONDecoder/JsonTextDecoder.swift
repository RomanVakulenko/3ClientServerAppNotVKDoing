//
//  JsonTextDecoder.swift
//  3JsonSerializationSample
//
//  Created by Roman Vakulenko on 26.07.2022.
//
...
"""
// MARK: - 4. вынес декодирование в отдельную сущность (файл с функцией, которую вызываю во вьюДидЛоад)
func decodeFromText() {
